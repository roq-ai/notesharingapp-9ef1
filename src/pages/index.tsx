...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`NoteSharingApp`}</title>

        <meta
          name="description"
          content="NoteSharingApp: Revolutionizing the way we store and share ideas, one note at a time. Experience seamless collaboration, improved productivity and ultimate convenience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517842645767-c639042777db?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxub3Rlc3xlbnwwfHx8fDE2OTcwMTIxNDB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dtravisphd?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`David Travis`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`NoteSharingApp: Revolutionizing the way we store and share ideas, one note at a time. Experience seamless collaboration, improved productivity and ultimate convenience.`}
            </Text>
            <Box
