...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': { roles: ['owner', 'admin'], key: 'order_id', tenantPath: [], userPath: [] },
  'payment_received.create': { roles: ['owner', 'admin'], key: 'payment_id', tenantPath: [], userPath: [] },
  'support_ticket_opened.create': { roles: ['owner', 'admin'], key: 'ticket_id', tenantPath: [], userPath: [] },
};
